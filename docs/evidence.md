...
- A later [normal-power-of-two specialization](optimization-notes.md#exact-powers-of-two) replaced two scaling products with shifts only in the irregular branch. The compact and full private `double` methods now measure 974 and 610 x64 native bytes. Focused [ShortRuns](benchmark-sessions/power-of-two-short.md) improved on both profiles; the minimal DLL lengths remain 12,288 and 20,480 B.
